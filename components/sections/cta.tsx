...
export default function CTASection() {
  return (
    <section className="bg-transparent pb-32 pt-10 px-4 -mt-40 relative z-20 pointer-events-none">
      <div className="container mx-auto max-w-[1200px] pointer-events-auto">
        <div className="bg-white rounded-[3rem] p-8 md:p-10 flex flex-col md:flex-row gap-12 md:gap-24 relative overflow-hidden">
          ...
          <div className="flex-1 relative z-10 flex flex-col justify-center">
            <h2 className="text-xl md:text-2xl font-bold text-black mb-6 tracking-tight leading-[1.1]">
              Governed by you <br />
              and +10,000 more stakers
            </h2>
            <p className="text-gray-500 mb-5 max-w-[300px] leading-relaxed text-sm">
          ...
          <div className="flex-1 relative z-10">
            <div className="bg-white rounded-3xl p-6 shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100 flex items-center justify-between gap-6 hover:shadow-lg transition-shadow duration-300 transform">
